"""
Django settings for mancrazeshoes project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'products.contexts.wishlist_count',
            ],
        },
    },
]
...
WSGI_APPLICATION = 'mancrazeshoes.wsgi.application'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'mancrazeshoes@example.com'
else:
